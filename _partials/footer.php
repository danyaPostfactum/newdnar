				...
				<div class="col-sm-12">
					<div class="payment-icons-row">
						...
						<span class="payment-icons-row-img">	
							<img src="<?php echo BASE_URL; ?>dist/assets/img/payment/visa_logo.png" height="18px" alt="">
							<img src="<?php echo BASE_URL; ?>dist/assets/img/payment/mastercard_logo.png" height="27px" alt="">
							<img src="<?php echo BASE_URL; ?>dist/assets/img/payment/sberbank_logo.png" height="29px" alt="">
							<img src="<?php echo BASE_URL; ?>dist/assets/img/payment/yandex-money.png" alt="">
							<img src="<?php echo BASE_URL; ?>dist/assets/img/payment/webmoney.png" alt="">
							<img src="<?php echo BASE_URL; ?>dist/assets/img/payment/qiwi.png" style="margin-top:2px;" alt="">
							<img src="<?php echo BASE_URL; ?>dist/assets/img/payment/rbk_logo.png" height="29px" alt="">
							<img src="<?php echo BASE_URL; ?>dist/assets/img/payment/bank-icon.png" height="29px" alt="">
						</span>	
