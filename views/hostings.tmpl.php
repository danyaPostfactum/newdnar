	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8">
				...
				<p>Наш сервис создан для сравнения тарифных планов хостинговых компаний под ваши нужды, что призвано помочь вам сократить время на поиск подходящего варианта, а также сэкономить средства.</p>
            </div>
