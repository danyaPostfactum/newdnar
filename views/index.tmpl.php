											...
											<div class="col-md-2 col-sm-4 price-list-column">
												<section class="price-list-item">
													<h4 style="display: inline-block;">
														<a class="price_tld" title="Регистрация домена в зоне .<?php if ($tld == 'xn--p1ai') { echo 'рф'; } else { echo $tld; } ?>" href="domains/<?php echo $tld; ?>">.<?php if ($tld == 'xn--p1ai') { echo 'рф'; } else { echo $tld; } ?></a>
													</h4>
							...
							<div class="row registration-rules heading-section">
								...
								<div class="col-sm-6">
									...
									<ul class="main-reasons-list">
									    ...
									    <li>бесплатную функцию "Private Person";</li>
									    <li>полное сокрытие всех данных для международных доменов;</li>
									    <li>бесплатный DNS сервер для всех доменов;</li>
									    <li>более 40 способов оплаты, в том числе безналичный расчет;</li>
									    <li>функцию массовой регистрации доменов;</li>
									    <li>бесплатную парковку доменов;</li>
									    <li>а также быструю и дружественную техническую поддержку.</li>
									</ul>
