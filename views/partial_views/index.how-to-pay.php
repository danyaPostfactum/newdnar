	<article id="payment" class="row tab-pane how-to-pay">
		...
		<section class="col-sm-12 payment-type" id="individual-person">
            <br>
            <div>После авторизации в личном кабинете - зайдите в раздел меню <img class="faq_icon" src="<?php echo BASE_URL; ?>dist/assets/img/faq/finances_icon.png" alt="Финансы"> «Финансы» и нажмите вверху кнопку <img class="faq_icon" src="<?php echo BASE_URL; ?>dist/assets/img/faq/bill_icon.png" alt="Пополнить баланс"> «Пополнить баланс». В появившейся форме введите сумму, которую Вы хотите зачислить на Ваш лицевой счет. Проверьте счет и нажмите на "Выставить счет". <br><strong>На все виды платежей для физических лиц - 0% комиссии!</strong></div>
