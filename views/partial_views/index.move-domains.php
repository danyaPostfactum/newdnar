...
<span class="glyphicon glyphicon-info-sign move-info"></span>В случае совпадения данных Администратора, указанных в нашей базе, и данных Администратора домена у прежнего Регистратора, домен будет принят в базу <b>автоматически</b>. В противном случае заявка будет передана <b>на ручную обработку</b>, о результатах которой вы будете уведомлены по e-mail.
...
Согласно <a href="http://www.cctld.ru/ru/docs/rules.php" rel="nofollow" target="_blank">Правилам регистрации доменных имен</a>, утвержденным Координационным Центром национального домена сети Интернет,  сменить Администратора домена возможно по истечении 30 дней после смены Регистратора. Таким образом, предоставлять необходимые документы на смену Администратора домена возможно только по истечении данного периода.
    ...
    <b>Вам необходимо:</b>
<ol>
    <li>Обратиться к текущему Регистратору, с просьбой снять статус блокировки с домена и предоставить код авторизации. Если данные по домену скрыты, их необходимо открыть.</li>
   <li><a href="<?php echo BASE_URL; ?>/#payment">Произвести оплату в личном кабинете</a> на сумму не менее суммы продления домена, в соответствии с тарифами.</li>
   <li>Сообщить нам кодовое слово (его нужно узнать у текущего Регистратора).</li>
   <li>Получив на контактный e-mail автоматическое сообщение от Робота о необходимости подтверждения запроса на смену Регистратора, кликнуть в письме на соответствующую ссылку. Ссылка действительна для подтверждения в течение 5 дней.</li>
   <li>Далее запрос на передачу обслуживания домена должен подтвердить текущий Регистратор (также в течение 5 дней).</li>
</ol><br>
